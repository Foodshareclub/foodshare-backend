...
const VERSION = "1.0.0";
const SUPPORTED_LOCALES = ["cs", "de", "es", "fr", "pt", "ru", "uk", "zh", "hi", "ar", "it", "pl", "nl", "ja", "ko", "tr", "sv", "vi", "id", "th"];
...
Deno.serve(async (req: Request) => {
  ...
  return new Response(JSON.stringify({
    ...
    version: VERSION,
    usage: {
      singleLocale: "GET ?locale=de",
      singleLocaleWithCategory: "GET ?locale=de&category=challenge",
      singleLocaleWithLimit: "GET ?locale=de&limit=100",
      allLocales: "GET ?all=true"
    },
