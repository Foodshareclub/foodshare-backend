...
\set anon_key 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJvbGUiOiJhbm9uIiwiaWF0IjoxNzcwNjU3NDM0LCJleHAiOjIwMDAwMDAwMDB9.yLUCg-p2c9ZrtG93G2LSctFKgczZ2VRE5Nu7FdLpcBc'
-- Service role key for self-hosted
\set service_key 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJvbGUiOiJzZXJ2aWNlX3JvbGUiLCJpYXQiOjE3NzA2NTc0MzQsImV4cCI6MjAwMDAwMDAwMH0.uI0M-5b5-WNbNPOUhaUVvtBWQtvWIOteMZaA1azIx-o'
...
SELECT cron.schedule('backfill-challenge-translations', '0 3 * * *', $$
  SELECT net.http_post(
    ...
    headers := '{"Content-Type": "application/json", "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJvbGUiOiJhbm9uIiwiaWF0IjoxNzcwNjU3NDM0LCJleHAiOjIwMDAwMDAwMDB9.yLUCg-p2c9ZrtG93G2LSctFKgczZ2VRE5Nu7FdLpcBc"}'::jsonb,
