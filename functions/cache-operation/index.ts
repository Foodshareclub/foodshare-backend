 ...
 * │                                                                             │
 * │   GET  /cache-operation              → Quick health ping                    │
 * │   GET  /cache-operation?check=health → Detailed Redis health                │
 * │   GET  /cache-operation?check=services → All Upstash services health        │
 * │   POST /cache-operation              → Cache operations                     │
 * │                                                                             │
 * └─────────────────────────────────────────────────────────────────────────────┘
 *
 * Features:
